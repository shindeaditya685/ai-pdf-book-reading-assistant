...
import { X, Sparkles, AlertCircle, RefreshCw, FileText, Download, Check, Play, ChevronRight } from 'lucide-react'
      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-foreground">AI Summarizer</h2>
          </div>
          <Button
            variant="ghost"
            size="icon"
